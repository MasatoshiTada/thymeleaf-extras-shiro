 ...
 */
public class LacksPermissionAttributeProcessor extends AbstractPermissionAttributeProcessor {

    private static final String ATTR_NAME = "lacksPermission";

    public LacksPermissionAttributeProcessor(String dialectPrefix) {
